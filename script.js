...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(img/clouds1.png)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(img/rainy1.png)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(img/cleear1.png)';
    }
    else if (status === 'Snow') {
        ...
        document.body.style.backgroundImage = 'url(img/mist1.png)';
    }

    else {
        document.body.style.backgroundImage = 'url(img/bg12.png)';
    }
}
